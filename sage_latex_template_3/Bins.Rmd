...
V2 = list(list("% Discharges to Hospital\r\nw/ Infx based on Primary\r\n& Other Diagnoses", 2, "% DC Infx", 0, 10),
         list("2014\r\nCensus", 1, "Avg Daily Census", 0, 30))
...
## The bottom one
grid.newpage()
pushViewport(viewport(x=0, y=0.02, width=1, height=.125,
                      just=c("left", "bottom")))
grid.draw(A[[1]])
upViewport()


pushViewport(viewport(x=0, y=0.045, width=1, height=.455,
                      just=c("left", "bottom")))
...
## Top Left
grid.newpage()
pushViewport(viewport(x=0, y=0.52, width=.5, height=.125,
                      just=c("left", "bottom")))
grid.draw(A[[1]])
upViewport()

pushViewport(viewport(x=0, y=0.565, width=.5, height=.455,
                      just=c("left", "bottom")))
drawDetails.lattice(A[[2]])
upViewport()
...
## Top Right
grid.newpage()
pushViewport(viewport(x=0.5, y=0.52, width=.5, height=.125,
                      just=c("left", "bottom")))
grid.draw(A[[1]])
upViewport()


pushViewport(viewport(x=0.5, y=0.565, width=.5, height=.455,
                      just=c("left", "bottom")))
drawDetails.lattice(A[[2]])
upViewport()
