...
V = list(list("% Discharges to Hospital\r\nw/ Infx based on Primary\r\n& Other Diagnoses", 2, "% DC Infx", 0, 10),
         list("% Discharge\r\nto Hospital", 0, "% DC", 0, 10),
         list("% Any MDRO",4,"MDRO", 0, 10),
         list("% Usage of Antibacterials\r\nStarted at Nursing Home", 0,"% Abx", 0, 10),
         list("2014\r\nCensus", .5, "Avg Daily Census", 0, 30),
         list("% Admissions\r\nw/ LOS: 100+", 0,"% Long Stay", 0, 10),
         list("Average # of Baths/Showers per Resident Per Week",0,"Baths/week", 0, 3),
         list("Avg Dependent \r\nLate Loss\r\nADLs", 0,"Late ADLs", 0, 4),
         list("Overall\r\nRating", 0,"CMS Star", 0, 5))

V1 =  list(list("% Discharges to Hospital\r\nw/ Infx based on Primary\r\n& Other Diagnoses", 0, "% DC Infx", 0, 10),
         list("% Discharge\r\nto Hospital", 0, "% DC", 0, 10),
         list("% Any MDRO",4,"MDRO", 0, 10),
         list("% Usage of Antibacterials\r\nStarted at Nursing Home", 0,"% Abx", 0, 10),
         list("2014\r\nCensus", 0, "Avg Daily Census", 0, 30),
         list("% Admissions\r\nw/ LOS: 100+", 0,"% Long Stay", 0, 10),
         list("Average # of Baths/Showers per Resident Per Week",0,"Baths/week", 0, 3),
         list("Avg Dependent \r\nLate Loss\r\nADLs", 0,"Late ADLs", 0, 4),
         list("Overall\r\nRating", 0,"CMS Star", 0, 5))

V2 =  list(list("% Discharges to Hospital\r\nw/ Infx based on Primary\r\n& Other Diagnoses", 5, "% DC Infx", 0, 10),
         list("% Discharge\r\nto Hospital", 0, "% DC", 0, 10),
         list("% Any MDRO",4,"MDRO", 0, 10),
         list("% Usage of Antibacterials\r\nStarted at Nursing Home", 0,"% Abx", 0, 10),
         list("2014\r\nCensus", .5, "Avg Daily Census", 0, 30),
...
A = makePlot(V = V, P = P, D = D, Tm = 300, NVs = 2, cols = c(1,5))

## Top Left
A1 = makePlot(V = V1, P = P1, D = D, Tm = 300, NVs = 2, cols = c(1,5))

## Top Right
A2 = makePlot(V = V2, P = P2, D = D, Tm = 300, NVs = 2, cols = c(1,5))
