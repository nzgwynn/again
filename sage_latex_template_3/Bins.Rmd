...
If investigators would like to use this method on studies with more than $2$ arms, $d^*_i$ can be redefined as, for example, the standard deviation between among the arms. 
