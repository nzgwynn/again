...
Need to add in here: 1) constrained randomization comments and 2) mention of the paper Bianca found [@greevy2012].
...
Covariate constrained randomization effectively enumerates all possible treatment assignments and eliminates those that do not meet with desired features of balance. Some experimental simulation has shown that it can perform well when used carefully [li2016] and that it appears not to badly violate assumptions of randomization.
Nonetheless, it is unclear to what degree each cluster will have an equal probability of assignment to each arm for any given trial, and whether any deviation from an equal probability of assignment to each arm is acceptable.
